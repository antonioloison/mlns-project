"""
Code deeply inspired by https://github.com/Tiger101010/DAEGC/tree/main/DAEGC
"""
...
def pretrain(dataset):
    ...
    for epoch in range(args.max_epoch):
        ...
        with torch.no_grad():
            ...
            clustering_report(y, [kmeans.labels_], ["DGAE"])
            print()
        if epoch % 10 == 0:
            torch.save(
                model.state_dict(), f"./predaegc_{args.name}_{epoch}.pkl"
            )
